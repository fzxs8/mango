...
import cn.zxczxc.logic.MangoTool;
import cn.zxczxc.provider.DBContentProvider;
import cn.zxczxc.provider.DBLabelProvider;
import cn.zxczxc.view.ITreeView;
import cn.zxczxc.view.NetAddressView;
import cn.zxczxc.view.OptionIems;
import cn.zxczxc.view.OptionIndexItem;
import cn.zxczxc.view.OptionPropertyItem;
import cn.zxczxc.view.OptionRoleItem;
import cn.zxczxc.view.OptionTableItem;
                        ...
                        public void doubleClick(DoubleClickEvent event) {
                            ...
                            if (obj instanceof NetAddressView) {
                                ...
                                try {
                                    ...
                                    children.add(new OptionTableItem("表", address));
                                    children.add(new OptionIndexItem("索引", address));
                                    children.add(new OptionRoleItem("角色", address));
                                    children.add(new OptionPropertyItem("属性", address));
                                    address.setChildren(children);
                                    event.getViewer().refresh();
                                    System.out.println(tool.getDatabaseNames());
                                ...
                                CTabItem tbtmBiao = new CTabItem(mainTabFolder, SWT.CLOSE);
                                tbtmBiao.setImage(opt.getIcon());
                                tbtmBiao.setText("表1");
