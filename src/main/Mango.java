...
import test.Factory;
import test.TreeContentProvider;
import test.TreeLabelProvider;
        ...
        container.setLayout(new BorderLayout(0, 0));
        {
            ...
            composite.setLayout(sl_composite);
            {
                ...
                composite_4.setLayout(new BorderLayout(0, 0));
                {
                    ...
                    CTabFolder tabFolder_1 = new CTabFolder(sashForm_2, SWT.BORDER);
                    ...
                    CTabItem tbtmBiao = new CTabItem(tabFolder_1, SWT.CLOSE);
                    tbtmBiao.setImage(SWTResourceManager.getImage(Mango.class, "/icon/table.gif"));
                    tbtmBiao.setText("表1");

                    CTabItem tabItem_1 = new CTabItem(tabFolder_1, SWT.CLOSE);
                    tabItem_1.setImage(SWTResourceManager.getImage(Mango.class, "/icon/table.gif"));
                    tabItem_1.setText("表2");

                    Button btnNewButton_3 = new Button(tabFolder_1, SWT.NONE);
                    tabItem_1.setControl(btnNewButton_3);
